    ...
    >
      ...
      <Container>
        <div className="max-w-2xl mx-auto lg:mx-0">
          <h1
            id="about-title"
            className="text-6xl font-medium tracking-tighter text-gray-900 font-display sm:text-7xl"
          >
            About Susanne
          </h1>
          <div className="text-sm prose prose-lg text-eye-green-dark sm:text-base">
            <p className="mt-4">
